...
1. use the search functionality [here](https://github.com/leilaicruz/LaanLab-SATAY-DataAnalysis/issues) to see if someone already filed the same issue;
...
1. Goto [GitHub release page](https://github.com/leilaicruz/LaanLab-SATAY-DataAnalysis/releases)
