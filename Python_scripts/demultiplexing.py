...
for line1 in f1:
    if temp < 10:
        ...
        if line1.startswith('@') and line2.startswith('@') and line1.split(' ')[0] == line2.split(' ')[0]:
            line1_header = line1.strip('\n')
            line2_header = line2.strip('\n')
            line1_seqnc = f1.readline().strip('\n')
            line2_seqnc = f2.readline().strip('\n')
            line1_dummy = f1.readline().strip('\n')
            line2_dummy = f2.readline().strip('\n')
            line1_phred = f1.readline().strip('\n')
            line2_phred = f2.readline().strip('\n')
