...
def list_known_essentials(input_files = None, headerlines=3):
    ...
    if input_files == None:
        ...
        essential_genes_files = [os.path.join(file_dirname,'..','..','resources','Cerevisiae_EssentialGenes_List_1.txt'),
                                os.path.join(file_dirname,'..','..','resources','Cerevisiae_EssentialGenes_List_2.txt')]
    else:
