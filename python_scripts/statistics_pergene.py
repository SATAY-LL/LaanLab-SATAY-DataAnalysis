...
#%%
def stats_pergene(filepath, filename, normalize=True):
    '''A graph is generated to show the distribution of the number of reads and the number of insertions for all genes combined.
    A bar plot is created for all genes (regardless about its essentiality) for the reads and insertions.
    A violinplot is created for all genes separated whether they are annotated essential or not for both the reads and insertions.
    '''
