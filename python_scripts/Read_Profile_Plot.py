...
def read_profile(chrom='I',bar_width=1000,binsize=1000,wig_file = None):
...
#    bar_width = 1000
    ...
    fig,ax = plt.subplots()
    ax.bar(allinsertionsites_list,allreadscounts_binnedlist,width=binsize)
    ax.set_yscale('log')
...
if __name__ == '__main__':
    read_profile('III',1000,1000,r"C:\Users\gregoryvanbeek\Desktop\E-MTAB-4885.WT1.bam.wig")